    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="py-8 text-center">
          ...
          <p className="text-lg text-purple-700 max-w-3xl mx-auto font-medium mt-2">
            Incluyendo cumplimiento con el Reglamento Peruano DS 115-2025-PCM
          </p>
        </header>
          ...
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription className="text-gray-700">
                ...
                en relación con los requisitos de la norma ISO 42001 y el reglamento peruano DS 115-2025-PCM.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                ...
                <ol className="list-decimal pl-5 space-y-2 text-gray-700">
                  <li>Seleccione la versión de evaluación que prefiera</li>
                  <li>Responda el cuestionario sobre cada componente</li>
                  <li>Obtendrá una puntuación para cada área evaluada</li>
                  <li>Visualice sus resultados en gráficos interactivos</li>
